...
export default function OnboardingThree() {
  return (
    <ImageBackground
      source={{ uri: 'https://images.unsplash.com/photo-1467453678174-768ec283a940?w=1600' }}
      style={styles.background}>
      <LinearGradient colors={['rgba(5,20,12,0.14)', 'rgba(5,20,12,0.84)']} style={styles.overlay}>
        <SafeAreaView style={styles.container}>
          <View style={styles.content}>
            <Text style={styles.title}>Build Daily Wellness Habits</Text>
            <Text style={styles.body}>
              Turn expert guidance into sustainable habits with a clean, elegant, and motivating health dashboard.
            </Text>
            ...
            <PrimaryButton label="Continue" icon="arrow-forward" onPress={() => router.replace('/auth/login')} />
